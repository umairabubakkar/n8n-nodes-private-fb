...
exports.FacebookTool = void 0;
const FacebookToolConfig_1 = require("./FacebookToolConfig");
const FacebookAIAgentLogger_1 = require("./FacebookAIAgentLogger");
class FacebookTool {
    constructor() {
        this.description = {
            ...
            inputs: [],
            outputs: ["ai_tool" /* NodeConnectionType.AiTool */],
            credentials: [
                {
            ...
            properties: [
                    ...
                    options: [
                        {
                            ...
                            value: 'all',
                            description: FacebookToolConfig_1.PRESET_DESCRIPTIONS.all
                        },
                        {
                            name: 'Content Creator',
                            value: 'content_creator',
                            description: FacebookToolConfig_1.PRESET_DESCRIPTIONS.content_creator
                        },
                        {
                            name: 'Community Manager',
                            value: 'community_manager',
                            description: FacebookToolConfig_1.PRESET_DESCRIPTIONS.community_manager
                        },
                        {
                            name: 'Analytics Only',
                            value: 'analytics_only',
                            description: FacebookToolConfig_1.PRESET_DESCRIPTIONS.analytics_only
                        },
                        {
                            name: 'Customer Support',
                            value: 'customer_support',
                            description: FacebookToolConfig_1.PRESET_DESCRIPTIONS.customer_support
                        },
                        {
                ...
                },
                {
                    ...
                    options: (() => {
                        const options = [];
                        FacebookToolConfig_1.ACTION_CATEGORIES.forEach(category => {
    ...
    async supplyData(itemIndex) {
        ...
        const baseDescription = this.getNodeParameter('description', itemIndex);
        const actionPreset = this.getNodeParameter('actionPreset', itemIndex, 'all');
        const customAllowedActions = this.getNodeParameter('allowedActions', itemIndex, []);
        const enableEnhancedLogging = this.getNodeParameter('enableEnhancedLogging', itemIndex, true);
        // Get the allowed actions based on preset or custom selection
        const allowedActions = (0, FacebookToolConfig_1.getFinalAllowedActions)({
        ...
        const self = this;
        const availableActions = allowedActions.length > 0 ? allowedActions : (0, FacebookToolConfig_1.getAllActions)();
        const tool = {
            ...
            invoke: async (args) => {
                ...
                try {
                    ...
                    if (enableEnhancedLogging) {
                        (0, FacebookAIAgentLogger_1.logAIAgentStart)(action, pageId, args);
                        (0, FacebookAIAgentLogger_1.logAIAgentInfo)(`Executing Facebook action: ${action}`, {
                            pageId: pageId,
                            arguments: args,
                    ...
                    const validation = (0, FacebookToolConfig_1.validateActionPermission)(action, allowedActions);
                    if (!validation.isAllowed) {
                        const eventType = validation.actionExists ? 'unauthorized_action' : 'invalid_action';
                        (0, FacebookToolConfig_1.logSecurityEvent)(eventType, {
                            action: action,
                        ...
                        if (enableEnhancedLogging) {
                            (0, FacebookAIAgentLogger_1.logAIAgentWarning)(`Action '${action}' not permitted`, {
                                validation: validation,
                                allowedActions: allowedActions.slice(0, 5)
                            });
                        }
                        const errorMessage = (0, FacebookToolConfig_1.generateUnauthorizedActionError)(action, allowedActions, validation);
                        return enableEnhancedLogging ? (0, FacebookAIAgentLogger_1.logAIAgentError)(action, errorMessage) : errorMessage;
                    }
                    // Execute the action
                    switch (action) {
...
💡 Fix: Provide a message parameter with your text content.`;
                                if (enableEnhancedLogging) {
                                    ...
                                    (0, FacebookAIAgentLogger_1.logAIAgentError)(action, 'Message is required for text posts');
                                }
                                return errorMessage;
                            }
                            if (enableEnhancedLogging) {
                                (0, FacebookAIAgentLogger_1.logAIAgentInfo)('Creating text post', { messageLength: args.message.length });
                            }
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Text post created successfully', textSuccessData);
                            }
...
💡 Fix: Provide an imageUrl parameter with a publicly accessible image URL.`;
                                if (enableEnhancedLogging) {
                                    ...
                                    (0, FacebookAIAgentLogger_1.logAIAgentError)(action, 'Image URL is required for photo posts');
                                }
                                return errorMessage;
                            }
                            if (enableEnhancedLogging) {
                                (0, FacebookAIAgentLogger_1.logAIAgentInfo)('Creating photo post', {
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Photo post created successfully', photoSuccessData);
                            }
                            return photoPostLogMessage;
                        case 'get_posts':
                            const limit = args.limit || 25;
                            if (enableEnhancedLogging) {
                                (0, FacebookAIAgentLogger_1.logAIAgentInfo)('Retrieving posts', { limit: limit });
                            }
                            ...
                            const postsSuccessData = {
                                ...
                                limit: limit,
                                posts: postsResponse.data.map((p) => {
                                    var _a, _b, _c, _d, _e;
                                    return ({
                                        id: p.id,
                                        message: (_a = p.message) === null || _a === void 0 ? void 0 : _a.substring(0, 50),
                                        likes: ((_c = (_b = p.likes) === null || _b === void 0 ? void 0 : _b.summary) === null || _c === void 0 ? void 0 : _c.total_count) || 0,
                                        comments: ((_e = (_d = p.comments) === null || _d === void 0 ? void 0 : _d.summary) === null || _e === void 0 ? void 0 : _e.total_count) || 0
                                    });
                                })
                            };
                            // Format posts for display
                            const postsDisplay = postsResponse.data.slice(0, 3).map((post, index) => {
                                var _a, _b, _c, _d, _e, _f;
                                return `${index + 1}. Post ID: ${post.id}
   Message: ${((_a = post.message) === null || _a === void 0 ? void 0 : _a.substring(0, 100)) || 'No text'}${((_b = post.message) === null || _b === void 0 ? void 0 : _b.length) > 100 ? '...' : ''}
   Likes: ${((_d = (_c = post.likes) === null || _c === void 0 ? void 0 : _c.summary) === null || _d === void 0 ? void 0 : _d.total_count) || 0} | Comments: ${((_f = (_e = post.comments) === null || _e === void 0 ? void 0 : _e.summary) === null || _f === void 0 ? void 0 : _f.total_count) || 0}
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, `Retrieved ${postsResponse.data.length} posts`, postsSuccessData);
                            }
                            return getPostsLogMessage;
                        case 'get_comments':
                            if (!args.postId) {
                                const error = 'Post ID is required to get comments';
                                return enableEnhancedLogging ? (0, FacebookAIAgentLogger_1.logAIAgentError)(action, error) : `Error: ${error}`;
                            }
                            if (enableEnhancedLogging) {
                                (0, FacebookAIAgentLogger_1.logAIAgentInfo)('Retrieving comments', {
                                    postId: args.postId,
                                    limit: args.limit || 25
                                });
                            }
                            ...
                            const commentsSuccessData = {
                                ...
                                comments: commentsResponse.data.map((c) => {
                                    ...
                                    return ({
                                        id: c.id,
                                        author: c.from.name,
                                        message: (_a = c.message) === null || _a === void 0 ? void 0 : _a.substring(0, 50),
                                        likes: c.like_count || 0
                                    });
                                })
                            };
                            // Format comments for display
                            const commentsDisplay = commentsResponse.data.slice(0, 3).map((comment, index) => {
                                var _a, _b;
                                return `${index + 1}. ${comment.from.name}: ${((_a = comment.message) === null || _a === void 0 ? void 0 : _a.substring(0, 80)) || 'No text'}${((_b = comment.message) === null || _b === void 0 ? void 0 : _b.length) > 80 ? '...' : ''}
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, `Retrieved ${commentsResponse.data.length} comments`, commentsSuccessData);
                            }
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Comment created successfully', commentSuccessData);
                            }
...
💡 Fix: Provide postId and either imageUrl or imageBinary parameters. Message is optional.`;
                                if (enableEnhancedLogging) {
                                    ...
                                    (0, FacebookAIAgentLogger_1.logAIAgentError)(action, 'Post ID and image data are required for image comments');
                                }
                                return errorMessage;
                            }
                            ...
                            if (enableEnhancedLogging) {
                                (0, FacebookAIAgentLogger_1.logAIAgentInfo)('Creating comment with image', {
                                    postId: args.postId,
                            ...
                            try {
                                ...
                                if (inputType === 'url') {
                                    try {
                                        ...
                                        if (enableEnhancedLogging) {
                                            (0, FacebookAIAgentLogger_1.logAIAgentWarning)('Direct URL method failed, trying upload method', {
...
- Page ID: ${pageId}`;
                                if (enableEnhancedLogging) {
                                    ...
                                    (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Image comment created successfully', imageCommentSuccessData);
                                }
                                ...
                                if (enableEnhancedLogging) {
                                    (0, FacebookAIAgentLogger_1.logAIAgentWarning)('Direct method failed, trying upload method', {
                                        error: directUrlError.message
                                    });
                                }
                                try {
...
- Page ID: ${pageId}`;
                                    if (enableEnhancedLogging) {
                                        ...
                                        (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Image comment created successfully', uploadSuccessData);
                                    }
                                    ...
                                    if (enableEnhancedLogging) {
                                        (0, FacebookAIAgentLogger_1.logAIAgentWarning)('Standard upload failed, trying resumable upload', {
...
- Page ID: ${pageId}`;
                                        if (enableEnhancedLogging) {
                                            ...
                                            (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Image comment created successfully via resumable upload', resumableSuccessData);
                                        }
                                        ...
                                        if (enableEnhancedLogging) {
                                            (0, FacebookAIAgentLogger_1.logAIAgentError)(action, finalError, {
...
📝 About: ${((_a = pageInfoResponse.about) === null || _a === void 0 ? void 0 : _a.substring(0, 100)) || 'No description'}${((_b = pageInfoResponse.about) === null || _b === void 0 ? void 0 : _b.length) > 100 ? '...' : ''}
...
- Page ID: ${pageId}`;
                            if (enableEnhancedLogging) {
                                ...
                                (0, FacebookAIAgentLogger_1.logAIAgentSuccess)(action, 'Page info retrieved successfully', pageInfoData);
                            }
                    ...
                    const action = (args === null || args === void 0 ? void 0 : args.action) || 'unknown_action';
...
- Check if the action is allowed for your page role`;
                    if (enableEnhancedLogging) {
                        ...
                        (0, FacebookAIAgentLogger_1.logAIAgentError)(action, errorMessage, {
                            error: error,
                            args: args,
                            pageId: pageId,
                            stack: error.stack
...
exports.FacebookTool = FacebookTool;
//# sourceMappingURL=FacebookTool.node.js.map